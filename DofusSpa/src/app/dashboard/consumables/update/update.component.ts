...
export class UpdateComponent extends BaseUpdateComponent<Consumable> implements OnInit {
  ...
  // Updating Consumable
  update() {
    this._consumableService.edit(this.data.id,this.form01.value).subscribe();
  }
