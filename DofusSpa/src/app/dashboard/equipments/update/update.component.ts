...
export class UpdateComponent extends BaseUpdateComponent<Equipment> implements OnInit {
  ...
  // Updating Equipment
  update() {
    this._equipmentService.edit(this.data.id,this.form01.value).subscribe();
  }
