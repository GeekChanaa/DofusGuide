...
export class UpdateComponent extends BaseUpdateComponent<Resource> implements OnInit {
  ...
  // Updating Resource
  update() {
    this._resourceService.edit(this.data.id,this.form01.value).subscribe();
  }
