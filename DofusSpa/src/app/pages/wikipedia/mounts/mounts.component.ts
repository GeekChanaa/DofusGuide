...
export class MountsComponent implements OnInit {
  ...
  // Getting Equipments
  getAll(){
    this._mountService.getAll(this.page,this.itemsPerPage).subscribe((data) => {
      this.mounts = data.result;
  ...
  changingPage(page : number){
    this._mountService.getAll(page,this.itemsPerPage,this.itemParams).subscribe((data) => {
      this.mounts = data.result;
    });
  }
  ...
  sortData(e){
    ...
    this._mountService.getAll(this.page,this.itemsPerPage,this.itemParams).subscribe((data)=> {
      this.mounts = data.result;
    })
  }
