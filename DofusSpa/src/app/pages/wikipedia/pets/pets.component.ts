...
export class PetsComponent implements OnInit {
  ...
  // Getting Equipments
  getAll(){
    this._petService.getAll(this.page,this.itemsPerPage).subscribe((data) => {
  ...
  changingPage(page : number){
    this._petService.getAll(page,this.itemsPerPage,this.itemParams).subscribe((data) => {
      this.pets = data.result;
    });
  }
  ...
  sortData(e){
    ...
    this._petService.getAll(this.page,this.itemsPerPage,this.itemParams).subscribe((data)=> {
      this.pets = data.result;
    })
  }
